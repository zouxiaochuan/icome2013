#ifndef _SEGMENTERHUMANFACETEMPLATEGRABCUT_H_
#define _SEGMENTERHUMANFACETEMPLATEGRABCUT_H_

#include <opencv2/opencv.hpp>
#include "superpixel.h"
#include "ASegmenter.h"

class SegmenterHumanFaceTemplateGrabcut : public ASegmenter
{
public:
...
public:
	SegmenterHumanFaceTemplateGrabcut(const std::string& mfilename, const std::string& templateFilename);
	~SegmenterHumanFaceTemplateGrabcut();
